...
var RoomsPage = (function () {
    function RoomsPage(navCtrl, navParams, modalCtrl, alertCtrl, db, actionSheetCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    RoomsPage.prototype.enterRoom = function (keyword) {
        var _this = this;
        console.log(keyword);
        ...
        var prompt = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: 'Save',
                    handler: function (data) {
                        var a = __WEBPACK_IMPORTED_MODULE_1_lodash__["findIndex"](_this.messages, function (o) {
...
LoginPage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_angularfire2_auth__["a" /* AngularFireAuth */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
], LoginPage);
